...
public class Card {
    ...
    public static void main(String[] args) {
        Comparator<Card> cardComparator = new SuitComparator().thenComparing(new PriceComporator.PriceComparator());
    ...
    private static class SuitComparator {
        public Comparator<Card> thenComparing(PriceComporator.PriceComparator priceComparator) {
            return null;
        }
    }
}
